...
begin
  if (ComboBox1.Text='Nom') then
     begin
        if (Length(Edit2.Text) > 0)  then
          ...
          begin
            ...
            messagedlg('Cette entreprise de maintenance n''existe pas dans la base de donnée', mtError,
                                    [mbCancel], 0);
          end;
    end
        ...
        if (Length(Edit2.Text)>0) then
          begin
            ...
            begin
              ...
              messagedlg('Cette entreprise de maintenance n''existe pas dans la base de donnée',mtError,[mbCancel], 0);
           end;
      end
    ...
    else if (ComboBox1.Text='Téléphone') then
      begin
        if (Length(Edit2.Text)>0) then
          begin
